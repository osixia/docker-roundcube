...
sed -i --follow-symlinks "s|dirname(\$_SERVER\['SCRIPT_FILENAME'\]).'/'|'/var/www/roundcube/'|g" /var/www/roundcube_bootstrap/program/include/iniset.php

sed -i --follow-symlinks "s/'SCRIPT_FILENAME'/'PATH_INFO'/g" /var/www/roundcube_bootstrap/program/include/rcmail.php
sed -i --follow-symlinks "s/\$_SERVER\['SCRIPT_NAME'\]/substr(\$_SERVER\['REQUEST_URI'\], 0, strpos(\$_SERVER\['REQUEST_URI'\], '\?'))/g" /var/www/roundcube_bootstrap/program/include/rcmail.php
